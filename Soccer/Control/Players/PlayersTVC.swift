...
class PlayersTableViewController: UIViewController{
    ...
    let iconsContainerView: UIView = {
        ...
        let images = [#imageLiteral(resourceName: "menajersIcon"), #imageLiteral(resourceName: "MiceImage"), #imageLiteral(resourceName: "soccer-image-8"), #imageLiteral(resourceName: "soccer-image-5"), #imageLiteral(resourceName: "changeTeamIcon"), #imageLiteral(resourceName: "SettingIcone")]
